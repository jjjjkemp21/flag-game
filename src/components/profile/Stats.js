...
import { ProgressRing, Pill } from '../ui/index';
...
function Stats({ flagsData }) {
    ...
    // flagsData hasn't arrived yet (or is empty) — show a friendly state inside
    // the card instead of a bare Back button floating over a blank panel.
    if (!stats) {
        return (
            <div className="stats-empty">
                <Icon name="bar_chart" />
                <p>Play a round to start tracking your progress — your accuracy, mastery, and streaks will show up here.</p>
            </div>
        );
    }
